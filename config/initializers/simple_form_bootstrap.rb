...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, tag: 'div', class: 'form-group', error_class: 'is-invalid was-validated' do |b|
    b.use :html5
    b.use :placeholder
  ...
  config.wrappers :vertical_file_input, tag: 'div', class: 'form-group', error_class: 'is-invalid was-validated' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
  ...
  config.wrappers :horizontal_file_input, tag: 'div', class: 'form-group', error_class: 'is-invalid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
  ...
  config.wrappers :horizontal_boolean, tag: 'div', class: 'form-group', error_class: 'is-invalid' do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :horizontal_radio_and_checkboxes, tag: 'div', class: 'form-group', error_class: 'is-invalid' do |b|
    b.use :html5
    b.optional :readonly
